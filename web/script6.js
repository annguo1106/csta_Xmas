...
const JSON_URL = 'https://docs.google.com/spreadsheets/d/1VxRqEu-tfz9wc-6wrNO0j7TFw9IkWhZL_MxB3cdqr9w/gviz/tq?tqx=out:json'; // 替換為你的表格 ID
...
async function fetchData() {
    try {
        ...
        const votes = { '交大-靈魂沙發馬鈴薯': 0, '清大-想在吉他社社辦唸書的我是否搞錯了什麼': 0 }; // 預設清大、交大票數為 0

        // 計算每個選項的票數
        rows.forEach(row => {
            const choice = row.c[1]?.v; // 假設選項在第二列
            if (choice === '交大-靈魂沙發馬鈴薯' || choice === '清大-想在吉他社社辦唸書的我是否搞錯了什麼') {
